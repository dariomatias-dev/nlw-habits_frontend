                    ...
                    availableWeekDays.map((weekDay, index) => {
                        return (
                            <Checkbox.Root
                                ...
                                checked={weekDay.includes(index.toString())}
                                onCheckedChange={() => handleToggleWeekDays(index)}
                            >
                                <div className='h-8 w-8 rounded-lg flex justify-center items-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500 transition-colors group-focus:ring-2 group-focus:ring-violet-700 group-focus:ring-offset-2 group-focus:ring-offset-background'>
                                    <Checkbox.Indicator>
